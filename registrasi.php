...
<div class="container" style="background-color:#666">
  ...
  <form role="form">
    ...
    <button type="submit" class="btn btn-default" style="background-color:#999">Submit</button> &nbsp; atau &nbsp;
    <button type="submit" class="btn btn-default" style="background-color:#CCC"><a href="register.php">Registrasi</a></button>
  </form>
</div>
